                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-6 col-xl-5 offset-xl-7">
                        <div class="banner_content">
                            <h3>KitKar<br/> Rental System</h3>
                            <p>KitKar System is a  web based application crafted using finnest and modern web programming languages to deliver high productivity, robustness and user friendlyness in Rental cars.</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-service">
                        ...
                        <div class="service-content">
                            <h5>Unique Design</h5>
                            <p>This application is crafted with unique designs that it can run on any platforms i.e(Smartphones, Tables and Laptops), Its unique design makes it responsive and lightweight.</p>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-service">
                        ...
                        <div class="service-content">
                            ...
                            <p>Payment records are processed directly in the payments module which makes it easy for the finance guys to analyse agency finances quickly and with less hassle</p>
                            <a href="{{ url('/features') }}">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-service">
                        ...
                        <div class="service-content">
                            ...
                            <p>Kitcar is shipped with a complex advanced reporting module which takes care of all reporting in the agency ranging from car rent records, car returns, payments, staff records, client records and car available records. This module utilises the data visualisation tools like graphs and charts.</p>
                            <a href="{{ url('/features') }}">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single-service">
                        ...
                        <div class="service-content">
                            ...
                            <p>Kitcar System has a finance and billing module which takes care of billing of rented cars, penalties or cars which have been returned damaged.</p>
                            <a href="{{ url('/features') }}">Read More</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="single-about">
                                ...
                                <div class="single-about-content">
                                    ...
                                    <p>Kitcar System is opensource that means each and every module in the system is shipped fully no trials or subscriptions needed.
